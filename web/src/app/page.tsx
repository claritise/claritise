    ...
    <main className="flex min-h-screen flex-col items-center justify-center">
      <div className="min-h-screen px-4 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          <section className="mb-8 rounded-lg bg-card p-6 shadow-md">
            <h2 className="mb-4 text-2xl font-semibold text-card-foreground">
              Welcome to My Corner of the Web
            </h2>
            <p className="text-muted-foreground">
              Hello! I&apos;m 𝒶𝓃𝓃𝒶𝑔𝓇𝒶𝓂, a passionate writer and tech enthusiast.
              This blog is where I share my thoughts on technology, literature,
              and life in general. Feel free to explore my posts and get in
              touch!
            </p>
          </section>
